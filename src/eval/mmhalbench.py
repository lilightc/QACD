...
def eval_model(args):
    ...
    for line in tqdm(questions, ncols=79):
        idx = line['question_id']

        image_file, query = line['image_path'], line['question']
...
def get_args():
    ...
    parser.add_argument('--question-file', type=str, default='data/MMHalBench/mmhalbench.jsonl')
